...
// Adicionar tipos de mutação para o módulo Kanban
export const SET_KANBAN_UI_FLAG = 'SET_KANBAN_UI_FLAG';
export const SET_KANBAN_BOARDS = 'SET_KANBAN_BOARDS';
export const SET_KANBAN_CURRENT_BOARD = 'SET_KANBAN_CURRENT_BOARD';
export const SET_KANBAN_BOARD_COLUMNS = 'SET_KANBAN_BOARD_COLUMNS';
export const ADD_KANBAN_BOARD = 'ADD_KANBAN_BOARD';
export const UPDATE_KANBAN_BOARD = 'UPDATE_KANBAN_BOARD';
export const REMOVE_KANBAN_BOARD = 'REMOVE_KANBAN_BOARD';
export const ADD_KANBAN_COLUMN = 'ADD_KANBAN_COLUMN';
export const UPDATE_KANBAN_COLUMN = 'UPDATE_KANBAN_COLUMN';
export const REMOVE_KANBAN_COLUMN = 'REMOVE_KANBAN_COLUMN';
export const ADD_KANBAN_CARD = 'ADD_KANBAN_CARD';
export const UPDATE_KANBAN_CARD = 'UPDATE_KANBAN_CARD';
export const REMOVE_KANBAN_CARD = 'REMOVE_KANBAN_CARD';
export const REORDER_KANBAN_COLUMNS = 'REORDER_KANBAN_COLUMNS';
export const REORDER_KANBAN_CARDS = 'REORDER_KANBAN_CARDS';
